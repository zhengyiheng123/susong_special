...
public class COmmitOrderAdapter extends BaseQuickAdapter<WineModel.GoodBean,BaseViewHolder> {
    Context context;
    public COmmitOrderAdapter(Context context,@Nullable List<WineModel.GoodBean> data) {
        super(R.layout.item_wine_order, data);
        this.context=context;
    }

    @Override
    protected void convert(BaseViewHolder helper, WineModel.GoodBean item) {
        ...
        helper.setText(R.id.commit_tv_num,"x"+item.getGoods_num());
    }
