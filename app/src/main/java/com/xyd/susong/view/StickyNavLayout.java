...
//    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        params.height = getMeasuredHeight() - mNav.getMeasuredHeight()-dp2px(this,120);
        setMeasuredDimension(getMeasuredWidth(),dp2px(this,120)+ mTop.getMeasuredHeight() + mNav.getMeasuredHeight() + mViewPager.getMeasuredHeight());
     ...
     * dp和像素转换
     */
    private int dp2px(StickyNavLayout context, float dipValue) {
