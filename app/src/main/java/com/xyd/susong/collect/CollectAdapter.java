...
public class CollectAdapter extends BaseQuickAdapter<CollectModel.MyCollectBean, BaseViewHolder> {
    private Context context;

    public CollectAdapter(@Nullable List<CollectModel.MyCollectBean> data, Context context) {
