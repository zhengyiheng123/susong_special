...
import com.xyd.susong.utils.ListenerManager;
...
public class EMHelper {
    ...
    public static EMHelper instance = new EMHelper();
    ...
    public void init(final Context context) {
        ...
        options.setAppkey("1116170807178027#kefuchannelapp45578");
        options.setTenantId("kefuchannelimid_033725");
                            ...
                            if (!TextUtils.isEmpty(agentInfo.getAvatar())) {
                                ...
                                if (!TextUtils.isEmpty(strUrl)) {
                                    ...
                                    Glide.with(context).load(strUrl).diskCacheStrategy(DiskCacheStrategy.ALL)
                                            .placeholder(com.hyphenate.helpdesk.R.drawable.hd_default_avatar)
