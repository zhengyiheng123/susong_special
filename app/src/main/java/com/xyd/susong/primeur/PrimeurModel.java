...
public class PrimeurModel {
    ...
    private List<PrimeurModel.ArticlesBean> articles;

    public List<PrimeurModel.ArticlesBean> getArticles() {
        return articles;
    }

    public void setArticles(List<PrimeurModel.ArticlesBean> articles) {
