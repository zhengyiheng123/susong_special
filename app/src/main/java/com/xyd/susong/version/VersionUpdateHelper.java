...
import com.xyd.susong.utils.NetworkUtils;
    ...
    public void onServiceConnected(ComponentName name, IBinder binder) {
        ...
        service.setCheckVersionCallBack(new VersionUpdateService.CheckVersionCallBack() {
            ...
            public void onSuccess() {
                ...
                builer.setMessage("当前版本：" + "v" + AppUtils.getAppVersionName(context) + "\n"
                        + "最新版本：v" + versionUpdateModel.getVersion_num() + "\n"
                        + "更新内容：" + versionUpdateModel.getDesc());
